               ...
               switch (__node.type) {
                    ...
                    case 'MethodCall': {
                         ...
                         try {
                              ...
                              const filtered = __node.filters ? this.#applyFilters(target, __node.filters, OGX.Format ?? {}) : target;
                    ...
                    case 'UxiCall': {
                         ...
                         try {
                              ...
                              const filtered = __node.filters ? this.#applyFilters(result, __node.filters, OGX.Format ?? {}) : result;
